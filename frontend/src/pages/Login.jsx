...
//   return (
//     <div className='w-full md:w-1/2 flex-col justify-center p-8 md:p-12'>
...
//       <img alt="Login to Account " className='h-[750px] w-full object-cover'/>
//     </div>
...
//       {/* Right: Image Section */}
//       <div className="hidden md:block w-1/2 pt-20 pr-10">
//         <img
